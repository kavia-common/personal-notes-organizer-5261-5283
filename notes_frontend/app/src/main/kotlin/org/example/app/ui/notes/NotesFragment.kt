...
/**
 * Shows all notes (optionally filtered by query). Pinned notes are listed on top.
 */
class NotesFragment : Fragment(), Searchable, NotesListAdapter.NoteClickListener {
    ...
    private fun loadData() {
        showLoading(true)
        repository.getAllNotes(currentQuery) { notes ->
            showLoading(false)
